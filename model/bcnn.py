...
class BCNN(BaseModel):
    def __init__(self, vocab, pretrained_word_embedding=None,
        ...
        super(BCNN, self).__init__(vocab)
    ...
    def _build_graph(self):
        ...
        conv1d = tf.layers.conv1d(input_x,filters=64,kernel_size=2,padding='valid')
        avg_pool = tf.reduce_mean(conv1d,axis=1)
        avg_max =  tf.reduce_max(conv1d,axis=1)
