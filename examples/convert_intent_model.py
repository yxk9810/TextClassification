...
'''
cuda_conv_fw = tf.load_op_library('/search/odin/yangyunlun/mrc-toolkit/sogou_mrc/cuda/kernel_fo_conv.so')
cuda_conv_bk = tf.load_op_library('/search/odin/yangyunlun/mrc-toolkit/sogou_mrc/cuda/kernel_fo_conv_grad.so')
cuda_pooling_fw = tf.load_op_library('/search/odin/yangyunlun/mrc-toolkit/sogou_mrc/cuda/kernel_fo_pooling.so')
cuda_pooling_bk = tf.load_op_library('/search/odin/yangyunlun/mrc-toolkit/sogou_mrc/cuda/kernel_fo_pooling_grad.so')
'''
...
with tf.Session(config=config) as sess:
    model_dir_path = "./news_checkpoint_new/best_weights"
