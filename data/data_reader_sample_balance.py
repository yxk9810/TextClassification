...
class DatasetReader(object):
    def __init__(self, data_file=None, train_file=None, dev_file=None,test_file =None,use_name_feature=True,use_pos_feature=False,use_char=True,use_bert=True,
        ...
        self.train_pos_indices = []
        self.train_neg_indices = [] 
        ...
        if train_file:
            self.train_pos_indices = [idx for idx,sample in enumerate(self.train_set) if sample['label']==1]
            self.train_neg_indices = [idx for idx,sample in enumerate(self.train_set) if sample['label']==0]
